...
public class HttpServer {
  ...
  static final String FILTER_INITIALIZER_PROPERTY = "bcbsp.http.filter.initializers";
...
public HttpServer(String name, String bindAddress, int port,
    ...
    final String appDir = conf.get("bsp.http.infoserver.webapps", "/root/workspace3.3.2/BC-BSP-0.1-libl3.6/webapps");
  ...
  protected void addDefaultApps(ContextHandlerCollection parent,
    ...
    // set up the context for "/logs/" if "bcbsp.log.dir" property is defined.
  ...
  protected String getWebAppsPath() throws IOException {
    return "/home/bc-bsp/bc-bsp-0.1/webapps";
  }
